...
#     projection = util.transforms.perspective( 45.0, width/float(height), 2.0, 10.0 )
...
#     # util.transforms.rotate(model, theta, 0,0,1)
#     # util.transforms.rotate(model, phi, 0,1,0)
...
faces = gloo.IndexBuffer(I)

O = [0,1, 1,2, 2,3, 3,0,
     4,7, 7,6, 6,5, 5,4,
     0,5, 1,6, 2,7, 3,4 ]
outline = gloo.IndexBuffer(O)
...
# util.transforms.translate(view, 0)
program['u_model'] = model
program['u_view'] = view
phi, theta = 0,0
